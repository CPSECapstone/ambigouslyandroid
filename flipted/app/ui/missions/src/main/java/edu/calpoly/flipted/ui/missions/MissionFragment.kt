        ...
        viewModel.currTaskInfo.observe(viewLifecycleOwner, Observer {
            if (it == null) {
                ...
                if (currTaskProgress != null) {
                    ...
                    reviewBtn.setOnClickListener {
                        taskViewModel.taskAndResponseValid.observe(viewLifecycleOwner, { valid ->
                            if (valid) {
                                navViewModel.navigator.openTaskResultsFragment(parentFragmentManager)
                            }
                        })
                    }
                } else {
                ...
                continueBtn.setOnClickListener {
                    navViewModel.navigator.openTaskFragment(parentFragmentManager, currTaskInfo.task.id)
                }
            }

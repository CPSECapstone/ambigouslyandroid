...
class ReviewResultsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val navViewModel = ViewModelProvider(requireActivity())[NavViewModel::class.java]
        ...
        taskBtn.setOnClickListener {
            ...
            navViewModel.navigator.openTaskFragment(parentFragmentManager, currTask.uid)
        }
        ...
        continueBtn.setOnClickListener {
            ...
            navViewModel.navigator.openMissionFragment(parentFragmentManager, "da0719ba103")
        }
